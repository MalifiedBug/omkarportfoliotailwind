import { BoltIcon,FolderOpenIcon,BeakerIcon,CheckIcon,PlayIcon,TicketIcon,ChartPieIcon, DevicePhoneMobileIcon, GlobeAltIcon, ScaleIcon } from '@heroicons/react/24/outline';
...
const features = [
  ...
  },
  {
    ...
    description:
      'Implemented a CRUD Movies Library app.',
    icon: TicketIcon,
  ...
  },
  {
    ...
    description:
      'Implemented a basic Youtube landing page.',
    icon: PlayIcon,
  ...
  },
  {
    name: 'Todo App',
    description:
      'Implemented basic todo app to add, edit and delete todo.',
    icon: CheckIcon,
  ...
  },
  {
    ...
    description:
      'Implemented Landing page of abstract.com - mockup.',
    icon: BeakerIcon,
    ...
    <div className="bg-white py-24 sm:py-32 lg:py-40">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="sm:text-center">
          <p className="mt-2 text-3xl font-bold tracking-tight text-indigo-600 sm:text-4xl">Mini-Projects</p>          
        </div>
            ...
            {features.map((feature) => (
              <div key={feature.name} className="relative flex flex-col gap-6 sm:flex-row md:flex-col lg:flex-row">
                <div className="flex cursor-pointer items-center justify-center rounded-xl bg-indigo-500 text-white sm:shrink-0">
                  <a href={feature.link} target="_blank"><feature.icon className="h-24 w-24" aria-hidden="true" /></a>
                  
                </div>                
                <div className="sm:min-w-0 sm:flex-1">
                  <p className="text-2xl font-semibold leading-8 text-gray-900">{feature.name}</p>
                  <p className="mt-2 text-xl leading-7 text-gray-600">{feature.description}</p>
                </div>
              </div>
            ))}
          </div>
